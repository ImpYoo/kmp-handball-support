...
fun Match.toResponseDto() = MatchResponseDto(
    ...
    refereeA = MatchPersonDto(refereeA.id, refereeA.name),
    refereeB = MatchPersonDto(refereeB.id, refereeB.name),
    timekeeper = MatchPersonDto(timekeeper.id, timekeeper.name),
    scorekeeper = MatchPersonDto(scorekeeper.id, scorekeeper.name),
